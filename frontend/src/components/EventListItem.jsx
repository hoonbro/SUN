...
const EventListItem = ({
  ...
  return (
    <Link
      ...
      className="w-full py-2 px-4 flex items-center justify-between transition-all cursor-pointer hover:bg-gray-50"
    >
      <div className="flex flex-1 items-stretch gap-2 h-9">
        <div className="flex flex-col gap-1 pr-2 border-r-2 border-teal-400 justify-center w-20 flex-shrink-0">
